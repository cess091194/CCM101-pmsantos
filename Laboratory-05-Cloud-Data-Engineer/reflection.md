...
Doing this laboratory activity helped me understand why object storage is used for things like photo-sharing apps instead of a regular hard drive. Block storage works more like a single disk that you have to manage and expand yourself, but object storage can hold a huge number of files without needing that kind of setup, which makes it a better choice when you're dealing with millions of photos.
